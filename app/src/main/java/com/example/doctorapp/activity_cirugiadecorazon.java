...
public class activity_cirugiadecorazon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        moreInfoButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Abrir una nueva actividad o pantalla con información detallada sobre la cirugía de corazón
                startActivity(new Intent(activity_cirugiadecorazon.this, MoreInfoActivity.class));
            }
        });
    }
    ...
    private String obtenerRecomendacion(String healthStatus) {
        ...
        switch (healthStatus) {
            case "Mal Estado":
                return "Recomendación para cirugía de corazón: [Si seleccionaste esto, estás en peligro. Debes acudir rápidamente a urgencias para iniciar la cirugía. La cirugía consiste en un cambio de corazón y la extracción de toda la sangre.]";
            case "Estado Regular":
                return "Recomendación para cirugía de corazón: [Recomendación para estado de salud regular]";
            case "Buena Salud":
                return "Recomendación para cirugía de corazón: [Recomendación para estado de salud bueno]";
            default:
